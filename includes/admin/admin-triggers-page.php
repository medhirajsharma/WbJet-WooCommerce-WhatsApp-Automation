<?php
// This file renders the Triggers admin page for WBWWA
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'delete' && !empty($_POST['trigger_id'])) {
    if (!isset($_POST['_wpnonce']) || !wp_verify_nonce($_POST['_wpnonce'], 'WBWWA_trigger_nonce')) {
        ...
        if ($deleted) {
            wp_redirect(admin_url('admin.php?page=WBWWAwc-triggers&msg=deleted'));
            exit;
        } else {
            add_settings_error('WBWWAwc_messages', 'db', 'Failed to delete trigger.', 'error');
        }
    }
}
?>
<div class="wrap WBWWA-admin">
    <div class="WBWWA-hero-card">
        ...
        <?php if (!$has_api_error): ?>
            <a href="<?php echo esc_url(admin_url('admin.php?page=WBWWAwc-trigger-edit')); ?>" class="button WBWWA-modern-btn add-notification-btn">
                    ...
                    <?php if (empty($triggers)) : ?>
                        <tr>
                            <td colspan="4" class="empty-table">
                                ...
                                No triggers found. <a href="<?php echo esc_url(admin_url('admin.php?page=WBWWAwc-trigger-edit')); ?>">Add one?</a>
                            </td>
                        </tr>
                    <?php else : ?>
                        <?php foreach ($triggers as $trigger) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo esc_url(admin_url('admin.php?page=WBWWAwc-trigger-edit&id=' . $trigger->id)); ?>"
